...
test:
	CLANG_MODULE_CACHE_PATH="$(repository_root)/.build/module-cache" SWIFTPM_MODULECACHE_OVERRIDE="$(repository_root)/.build/module-cache" swift test --disable-sandbox
